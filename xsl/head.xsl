...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
            ...
            <xsl:when test="@type = 'chapter'">
                <xsl:choose>
                    <xsl:when test="tei:orig[@rend = 'center']">
                        <h2 class="chapter-heading-centered">
                            <xsl:apply-templates select="tei:orig"/>
                        </h2>
                    </xsl:when>
                    <xsl:otherwise>
    ...
    <!-- Level 4 head -->
    <xsl:template
        match="tei:front/tei:div/tei:div/tei:div/tei:div/tei:head | tei:body/tei:div/tei:div/tei:div/tei:div/tei:head | tei:back/tei:div/tei:div/tei:div/tei:div/tei:head">
        <xsl:choose>
            <xsl:when test="@type = 'add'">
                <!--<h4 class="metadata">
                    <xsl:apply-templates/>
